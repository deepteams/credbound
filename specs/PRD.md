...
| DATA-001 | PostgreSQL | A schema and Goose migrations are provided, all objects in the dedicated `credbound` schema. |
...
- Migrations are tested on PostgreSQL; it may be marked as not
