...
is not allowed. Validated SSO authentication is AAL2. For step-up, the port
receives `ForceReauthentication=true` so that the IdP applies its own MFA policy.
